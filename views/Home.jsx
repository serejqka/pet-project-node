      ...
      <div className="container py-4">
        ...
        <div className="p-5 mb-4 bg-light rounded-3">
          <div className="container-fluid py-5">
            <h1 className="display-5 fw-bold">Custom Express Project</h1>
            <p className="col-md-8 fs-4">An example of a Pet Project with basic registration and authorization using sessions</p>
            <a
              href="https://github.com/serejqka/pet-project-node"
              target="_blank"
